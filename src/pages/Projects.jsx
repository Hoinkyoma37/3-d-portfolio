...
function Projects() {
  return (
    <section className="max-container">
      <h1>My Projects <span className="blue-gradient_text font-semibold drop-shadow">Aldahir</span>
      </h1>

      <div className="mt-5 flex-col gap-3 text-slate-500">
        <p>I've Embark on numerous projects throughout the years, but these are the ones I hold closest to my Heart. Many of them are open-source, so if you come across something that piques your interest, feel free to explore the codebase and contribute youre ideas for further enhancments. Your Collaboration is highly valued! </p>
      </div>
